...
class AttendanceController:
    ...
    def markAttendance(attendance_data, course_code):
        try:
            ...
            messagebox.showerror("Error", f"An error occurred while saving the attendance file: {e}")
    ...
    def addAttendanceToExistingFile(file_path, attendance_data):
        try:
            ...
            print(f"An error occurred: {e}")
            messagebox.showerror("Error", f"An error occurred while adding attendance to the existing file: {e}")
