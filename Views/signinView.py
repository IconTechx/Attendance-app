...
class SignInView(tk.Tk):
    def __init__(self, controller):
        ...
        self.sign_up_button = tk.Button(self.left_container, text="Sign Up", font=button_font, command=self.controller.open_sign_up_page, bg="white", fg="black",  bd=0, relief="flat", height=2)  # Remove outline and increase height
    ...
    def open_folder(self):
        folder_path = r"C:\Users\USER\Desktop\faceRecognitionAttendance-master\attendanceList"
